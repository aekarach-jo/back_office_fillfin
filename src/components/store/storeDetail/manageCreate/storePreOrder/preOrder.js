...
import AllPreorder from './allPreorder'
...
export default function PreOrder({preOrderList, apiGetStore}) {
    ...
    <div className="w-full sm:px-0">
      <Tab.Group>
        ...
        <Tab.Panels className="mt-2">
          ...
          >
            <AllPreorder preOrderList={preOrderList} apiGetStore={apiGetStore}/>
          </Tab.Panel>
          <Tab.Panel
            className={classNames(
              'rounded-xl bg-white',
          ...
          >
            <CreatePreorder apiGetStore={apiGetStore}/>
          </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
    </div>
